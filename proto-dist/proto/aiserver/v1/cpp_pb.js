...
define(
	...
	function (
		...
		(function (Wt) {
			...
			H || (e.CppStoppedTrackingModelEvent_StoppedTrackingModelReason = H = {}),
		),
			t.proto3.util.setEnumType(
				H,
		...
		(function (Wt) {
			...
			xe || (e.BugBotLinterEvent_NotShownBecauseHeuristic_Heuristic = xe = {}),
		),
			t.proto3.util.setEnumType(
				xe,
		...
		class De extends t.Message {
			constructor(tt) {
				super(), (this.errorMessage = ""), t.proto3.util.initPartial(tt, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		(function (Wt) {
			...
			t.proto3.util.setEnumType(je, "aiserver.v1.AiRequestEvent.RequestType", [
