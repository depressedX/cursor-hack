	...
	function (
		...
		(function (Ye) {
			(Ye[(Ye.RECHUNKER_CHOICE_UNSPECIFIED = 0)] =
				...
				(Ye[(Ye.RECHUNKER_CHOICE_IDENTITY = 1)] = "RECHUNKER_CHOICE_IDENTITY"),
				(Ye[(Ye.RECHUNKER_CHOICE_600_TOKS = 2)] = "RECHUNKER_CHOICE_600_TOKS"),
		...
		(function (Ye) {
			...
			t.proto3.util.setEnumType(Ae, "aiserver.v1.UpgradeScopeResponse.Status", [
				{ no: 0, name: "STATUS_UNSPECIFIED" },
				{ no: 1, name: "STATUS_SUCCESS" },
				{ no: 2, name: "STATUS_FAILURE" },
			]);
		...
		class De extends t.Message {
			constructor(ze) {
				super(), (this.repositories = []), t.proto3.util.initPartial(ze, this);
			}
			static {
				this.runtime = t.proto3;
			}
