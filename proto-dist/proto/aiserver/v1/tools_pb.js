...
define(
	...
	function (
		...
		class N extends t.Message {
			constructor(We) {
				super(), (this.directoryPath = ""), t.proto3.util.initPartial(We, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		(function (wt) {
			...
			ee || (e.RipgrepSearchResultInternal_SearchCompletionExitCode = ee = {}),
		),
			t.proto3.util.setEnumType(
				ee,
		...
		class et extends t.Message {
			constructor(We) {
				super(), (this.searchResults = []), t.proto3.util.initPartial(We, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class ri extends t.Message {
			constructor(We) {
				super(), (this.errorMessage = ""), t.proto3.util.initPartial(We, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		(function (wt) {
			...
			t.proto3.util.setEnumType(at, "aiserver.v1.EditParams.FrontendEditType", [
