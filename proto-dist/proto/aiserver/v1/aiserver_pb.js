...
define(
	...
	function (
		...
		class s extends t.Message {
			constructor(we) {
				super(), (this.isFinished = !1), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class T extends t.Message {
			constructor(we) {
				super(), (this.rankedFiles = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class M extends t.Message {
			constructor(we) {
				super(), (this.diffCharLen = 0), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class W extends t.Message {
			constructor(we) {
				super(), (this.contextToRank = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class X extends t.Message {
			constructor(we) {
				super(), (this.rankedContext = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class $e extends t.Message {
			constructor(we) {
				super(), (this.instruction = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		(function (Bi) {
			...
			t.proto3.util.setEnumType(fe, "aiserver.v1.BackgroundCmdKRequest.Type", [
		...
		class Ae extends t.Message {
			constructor(we) {
				super(), (this.embeddings = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class De extends t.Message {
			constructor(we) {
				super(), (this.commitHash = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class Ze extends t.Message {
			constructor(we) {
				super(), (this.aiResponse = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class Ye extends t.Message {
			constructor(we) {
				super(), (this.scoredEdits = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class ei extends t.Message {
			constructor(we) {
				super(), (this.enableCards = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class mi extends t.Message {
			constructor(we) {
				super(), (this.description = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class $i extends t.Message {
			constructor(we) {
				super(), (this.featureName = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class yi extends t.Message {
			constructor(we) {
				super(), (this.availableDocs = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class ai extends t.Message {
			constructor(we) {
				super(), (this.conversation = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		(function (Bi) {
			...
			t.proto3.util.setEnumType($t, "aiserver.v1.ModelQueryRequest.QueryType", [
		...
		class Mn extends t.Message {
			constructor(we) {
				super(), (this.codeResults = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class Hn extends t.Message {
			constructor(we) {
				super(), (this.docIdentifier = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		(function (Bi) {
			...
			t.proto3.util.setEnumType(ts, "aiserver.v1.HealthCheckResponse.Status", [
				{ no: 0, name: "STATUS_UNSPECIFIED" },
		...
		class dn extends t.Message {
			constructor(we) {
				super(), (this.previousEdits = []), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class Yr extends t.Message {
			constructor(we) {
				super(), (this.pseudocode = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		(function (Bi) {
			...
			t.proto3.util.setEnumType(uo, "aiserver.v1.CppConfigResponse.Heuristic", [
		...
		class Lr extends t.Message {
			constructor(we) {
				super(), (this.potentialLoc = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class oi extends t.Message {
			constructor(we) {
				super(), (this.symbolName = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class ur extends t.Message {
			constructor(we) {
				super(), (this.didWarmCache = !1), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class vo extends t.Message {
			constructor(we) {
				super(), (this.modelOutput = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class zs extends t.Message {
			constructor(we) {
				super(), (this.doableAsTask = !1), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		(function (Bi) {
			...
			t.proto3.util.setEnumType(pn, "aiserver.v1.ReportBugRequest.BugType", [
		...
		(function (Bi) {
			...
			t.proto3.util.setEnumType(Fo, "aiserver.v1.ReportCmdKFateRequest.Fate", [
		...
		class Ro extends t.Message {
			constructor(we) {
				super(), (this.commitMessage = ""), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
		...
		class Jo extends t.Message {
			constructor(we) {
				super(), (this.didKeepWarm = !1), t.proto3.util.initPartial(we, this);
			}
			static {
				this.runtime = t.proto3;
			}
