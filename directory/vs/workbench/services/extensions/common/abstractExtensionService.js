...
import './extensionDescriptionRegistry.js';
...
import './extensionRunningLocationTracker.js';
import './extensions.js';
import './extensionsRegistry.js';
import './lazyCreateExtensionHostManager.js';
import './rpcProtocol.js';
import './workspaceContains.js';
...
define(
			...
			function (				ce /*require*/,
				...
				S /*productService*/,
				I /*platform*/,
				T /*remoteAuthorityResolver*/,
				P /*remoteExtensionsScanner*/,
				k /*telemetry*/,
				L /*workspace*/,
				D /*environmentService*/,
				M /*extensionFeatures*/,
				N /*extensionManagement*/,
				A /*extensionDescriptionRegistry*/,
				R /*extensionDevOptions*/,
				O /*extensionHostKind*/,
				B /*extensionHostManager*/,
				U /*extensionManifestPropertiesService*/,
				z /*extensionRunningLocation*/,
				F /*extensionRunningLocationTracker*/,
				x /*extensions*/,
				H /*extensionsRegistry*/,
				q /*lazyCreateExtensionHostManager*/,
				V /*rpcProtocol*/,
				G /*workspaceContains*/,
				K /*lifecycle*/,
				J /*remoteAgentService*/,
) {
				"use strict";
				var W;
