...
import '../../../contrib/notebook/browser/controller/cellOperations.js';
...
import '../../../../../proto/aiserver/v1/inline_gpt4_pb.js';
...
import '../../../../../proto/aiserver/v1/fastpreviews_pb.js';
...
import './gitContextService.js';
import '../../../contrib/contextGraph/browser/gitGraphService.js';
import '../../../../editor/contrib/documentSymbols/browser/outlineModel.js';
import '../../magicLink/browser/magicLinkService.js';
import './aiFileInfoService.js';
...
define(
			...
			function (				ce /*require*/,
				...
				B /*aiErrorService*/,
				U /*aiSettingsService*/,
				z /*authenticationService*/,
				F /*environmentService*/,
				x /*dataScrubbingService*/,
				H /*markers*/,
				q /*reducerService*/,
				V /*uploadserver_pb*/,
				G /*network*/,
				K /*editorGroupsService*/,
				J /*fastContextService*/,
				W /*aiUtilsService*/,
				X /*inline_gpt4_pb*/,
				Y /*cursorEvalService*/,
				ie /*constants*/,
				...
				te /*backendClient*/,
				Q /*cmdk_pb*/,
				Z /*interpreter_connectweb*/,
				se /*aibranch_connectweb*/,
				re /*hallucinated_functions_connectweb*/,
				le /*chat_pb*/,
				oe /*resolverService*/,
				ae /*chatDataService*/,
				pe /*chatData*/,
				...
				ye /*map*/,
				ue /*debug*/,
				fe /*codeEditorService*/,
				me /*path*/,
				ve /*files*/,
				ge /*cppEventLogger*/,
				be /*gitContextService*/,
				Ce /*gitGraphService*/,
				Le /*outlineModel*/,
				Fe /*magicLinkService*/,
				Oe /*aiFileInfoService*/,
				xe /*utils*/,
) {
				"use strict";
