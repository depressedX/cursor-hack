...
define(
			...
			function (				ce /*require*/,
				...
				u /*diffEditorInput*/,
				a /*editorGroupModel*/,
				h /*sideBySideEditorInput*/,
				c /*textResourceEditorInput*/,
				n /*chatEditorInput*/,
				g /*customEditorInput*/,
				p /*interactiveEditorInput*/,
				o /*mergeEditorInput*/,
				f /*multiDiffEditorInput*/,
				b /*notebookEditorInput*/,
				s /*terminalEditorInput*/,
				l /*webviewEditorInput*/,
				y /*editorGroupColumn*/,
				$ /*editorGroupsService*/,
				v /*editorService*/,
				S /*extHostCustomers*/,
