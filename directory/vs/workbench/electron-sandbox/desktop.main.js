...
define(
		...
		function (			ce /*require*/,
			...
			f /*lifecycle*/,
			b /*services*/,
			s /*mainProcessService*/,
			l /*sharedProcessService*/,
			y /*remoteAuthorityResolverService*/,
			$ /*remoteAuthorityResolver*/,
			v /*remoteAgentService*/,
			S /*remoteAgentService*/,
			I /*fileService*/,
			T /*files*/,
			P /*remoteFileSystemProviderClient*/,
			k /*configurationCache*/,
			L /*sign*/,
			D /*productService*/,
			M /*uriIdentity*/,
			N /*uriIdentityService*/,
			A /*nativeKeyboardLayoutService*/,
			R /*mainProcessService*/,
			O /*logIpc*/,
			B /*ipc*/,
			U /*logService*/,
			z /*workspaceTrust*/,
			F /*workspaceTrust*/,
			x /*objects*/,
			H /*utilityProcessWorkerWorkbenchService*/,
			q /*platform*/,
			V /*network*/,
			G /*diskFileSystemProvider*/,
			K /*fileUserDataProvider*/,
			J /*userDataProfile*/,
			W /*userDataProfileIpc*/,
			X /*policyIpc*/,
			Y /*policy*/,
			ie /*userDataProfileService*/,
			ne /*userDataProfile*/,
			ee /*browserSocketFactory*/,
			_ /*remoteSocketFactoryService*/,
			te /*electronRemoteResourceLoader*/,
			Q /*window*/,
			Z /*window*/,
) {
			"use strict";
