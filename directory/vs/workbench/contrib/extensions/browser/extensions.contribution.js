...
import './extensionEditor.js';
import './extensionsViewlet.js';
...
import './extensionsQuickAccess.js';
...
import './abstractRuntimeExtensionsEditor.js';
import './extensionEnablementWorkspaceTrustTransitionParticipant.js';
...
define(
			...
			function (				ce /*require*/,
				...
				f /*jsonContributionRegistry*/,
				b /*extensionsFileTemplate*/,
				s /*commands*/,
				l /*instantiation*/,
				y /*extensionsUtils*/,
				$ /*extensionManagementUtil*/,
				v /*editor*/,
				S /*lifecycle*/,
				I /*uri*/,
				T /*extensionsActivationProgress*/,
				P /*errors*/,
				k /*extensionsDependencyChecker*/,
				L /*cancellation*/,
				D /*views*/,
				M /*viewsService*/,
				N /*clipboardService*/,
				...
				R /*contextkey*/,
				O /*quickAccess*/,
				B /*extensionsQuickAccess*/,
				U /*extensionRecommendationsService*/,
				z /*userDataSync*/,
				F /*clipboard*/,
				x /*editorService*/,
				H /*extensionsWorkbenchService*/,
				q /*actionCommonCategories*/,
				V /*extensionRecommendations*/,
				G /*extensionRecommendationNotificationService*/,
				K /*notification*/,
				J /*host*/,
				W /*contextkeys*/,
				X /*workspaceExtensionsConfig*/,
				Y /*network*/,
				ie /*abstractRuntimeExtensionsEditor*/,
				ne /*extensionEnablementWorkspaceTrustTransitionParticipant*/,
				ee /*extensionsIcons*/,
				_ /*extensions*/,
				te /*lifecycle*/,
				Q /*dialogs*/,
				...
				re /*editor*/,
				le /*workspaceTrust*/,
				oe /*extensionsCompletionItemsProvider*/,
				ae /*quickInput*/,
				pe /*event*/,
				$e /*panecomposite*/,
				ye /*unsupportedExtensionsMigrationContribution*/,
				ue /*platform*/,
				fe /*extensionStorage*/,
				me /*storage*/,
				ve /*preferences*/,
				ge /*deprecatedExtensionsChecker*/,
				be /*progress*/,
				Ce /*uriIdentity*/,
				Le /*configuration*/,
) {
