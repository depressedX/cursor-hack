...
define(
			...
			function (				ce /*require*/,
				...
				o /*range*/,
				f /*model*/,
				b /*contentHoverController2*/,
				s /*marginHoverController*/,
				l /*nls*/,
				y /*accessibility*/,
				...
				B /*themeService*/,
				U /*labels*/,
				z /*accessibilityConfiguration*/,
				F /*accessibilityCommands*/,
				x /*chatExecuteActions*/,
				H /*chatFollowups*/,
				q /*chatAgents*/,
				V /*chatContextKeys*/,
				G /*chatWidgetHistoryService*/,
				K /*simpleEditorOptions*/,
) {
				"use strict";
				var J;
