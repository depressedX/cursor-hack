...
define(
			...
			function (				ce /*require*/,
				...
				p /*views*/,
				o /*fileConstants*/,
				f /*codeCoverageDecorations*/,
				b /*icons*/,
				s /*testCoverageView*/,
				l /*testingDecorations*/,
				y /*testingExplorerView*/,
				$ /*testingOutputPeek*/,
				v /*testingProgressUiService*/,
				S /*testingViewPaneContainer*/,
				I /*configuration*/,
				T /*constants*/,
				P /*testCoverageService*/,
				k /*testExplorerFilterState*/,
				L /*testId*/,
				D /*testProfileService*/,
				M /*testResultService*/,
				N /*testResultStorage*/,
				A /*testService*/,
				R /*testServiceImpl*/,
				O /*testingContentProvider*/,
				B /*testingContextKeys*/,
				U /*testingContinuousRunService*/,
				z /*testingDecorations*/,
				F /*testingPeekOpener*/,
				x /*lifecycle*/,
				H /*viewsService*/,
				q /*testExplorerActions*/,
) {
				"use strict";
