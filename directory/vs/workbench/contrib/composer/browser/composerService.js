...
define(
		...
		function (			ce /*require*/,
			...
			x /*label*/,
			H /*opener*/,
			q /*reactiveStorageService*/,
			V /*reactiveStorageTypes*/,
			G /*undoRedo*/,
			K /*workspace*/,
			J /*editor*/,
			W /*textResourceEditorInput*/,
			X /*codeSelections*/,
			Y /*contextBankService*/,
			ie /*aiFeatureStatusService*/,
			ne /*utils*/,
			ee /*composer*/,
			_ /*composerCapabilities*/,
			te /*composerContextKeys*/,
			Q /*composerData*/,
			Z /*composerDataCreation*/,
			se /*composerDataService*/,
			re /*composerDiffEditorInput*/,
			le /*composerUtilsService*/,
			oe /*composerViews*/,
			ae /*fileEditorInput*/,
			pe /*multiDiffEditorInput*/,
			$e /*recentFilesTrackerService*/,
			ye /*terminal*/,
			ue /*chatAndComposerSuggestedFileReranking*/,
			fe /*aiFileInfoService*/,
			me /*aiMiscServices*/,
			ve /*aiService*/,
			ge /*backendClient*/,
			be /*cursorCredsService*/,
			Ce /*fastEditService*/,
			Le /*gitContextService*/,
			Fe /*repositoryService*/,
			Oe /*toolsV2Service*/,
			xe /*utils*/,
			He /*dataScrubbingService*/,
			Ke /*aiErrorService*/,
			Je /*authenticationService*/,
			Te /*editorGroupsService*/,
			Ee /*editorService*/,
			Ie /*lifecycle*/,
			Be /*selectedContext*/,
			Se /*selectedContextData*/,
			ke /*utils*/,
			Ue /*viewsService*/,
			qe /*utils*/,
			Ae /*markers*/,
			...
			De /*tracing*/,
			Re /*tools_pb*/,
			je /*aiApplyToFileActionsService*/,
			Ve /*terminalExecutionService*/,
			Ze /*prettyDialog*/,
			et /*toolsV2HandlerRegistryService*/,
			rt /*inlineDiffUndoRedoElement*/,
			ft /*filesConfigurationService*/,
			bt /*textfiles*/,
			nt /*resourceEditorInput*/,
			lt /*constants*/,
			ct /*utils*/,
			gt /*index*/,
			ht /*utils*/,
