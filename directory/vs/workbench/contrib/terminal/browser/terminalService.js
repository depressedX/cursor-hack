...
define(
			...
			function (				ce /*require*/,
				...
				I /*viewsService*/,
				T /*terminal*/,
				P /*terminalEditorInput*/,
				k /*terminalIcon*/,
				L /*terminalProfileQuickpick*/,
				D /*terminalUri*/,
				M /*terminal*/,
				N /*terminalContextKey*/,
				A /*editorGroupColumn*/,
				...
				U /*extensions*/,
				z /*lifecycle*/,
				F /*remoteAgentService*/,
				x /*telemetry*/,
				H /*reactiveStorageService*/,
				q /*xtermTerminal*/,
				V /*terminalInstance*/,
				G /*keybinding*/,
				K /*terminalCapabilityStore*/,
				J /*timerService*/,
				W /*performance*/,
				X /*detachedTerminal*/,
				Y /*terminalEvents*/,
				ie /*terminalActionsRegistry*/,
				ne /*window*/,
				ee /*fastContextService*/,
) {
				"use strict";
