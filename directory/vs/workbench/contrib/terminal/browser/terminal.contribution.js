...
define(
			...
			function (				ce /*require*/,
				...
				g /*platform*/,
				p /*terminal*/,
				o /*terminalLogService*/,
				f /*terminalPlatformConfiguration*/,
				b /*editor*/,
				s /*viewPaneContainer*/,
				l /*quickaccess*/,
				y /*contributions*/,
				$ /*editor*/,
				v /*views*/,
				S /*remoteTerminalBackend*/,
				I /*terminal*/,
				T /*terminalActions*/,
				P /*terminalCommands*/,
				k /*terminalConfigurationService*/,
				L /*terminalEditor*/,
				D /*terminalEditorInput*/,
				M /*terminalEditorSerializer*/,
				N /*terminalEditorService*/,
				A /*terminalGroupService*/,
				R /*terminalIcons*/,
				O /*terminalInstanceService*/,
				B /*terminalMainContribution*/,
				U /*terminalMenus*/,
				z /*terminalProfileService*/,
				F /*terminalQuickAccess*/,
				x /*terminalService*/,
				H /*terminalView*/,
				q /*terminalWslRecommendationContribution*/,
				V /*terminal*/,
				G /*terminalColorRegistry*/,
				K /*terminalConfiguration*/,
				J /*terminalContextKey*/,
				W /*terminalStrings*/,
				X /*terminalSuggestConfiguration*/,
) {
				"use strict";
