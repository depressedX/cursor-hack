...
define(
			...
			function (				ce /*require*/,
				...
				H /*telemetry*/,
				q /*capabilities*/,
				V /*terminalCapabilityStore*/,
				G /*environmentVariableShared*/,
				K /*terminal*/,
				J /*terminalStrings*/,
				W /*colorRegistry*/,
				X /*iconRegistry*/,
				...
				_ /*views*/,
				te /*viewsService*/,
				Q /*accessibilityConfiguration*/,
				Z /*terminal*/,
				se /*terminalActions*/,
				re /*terminalEditorInput*/,
				le /*terminalExtensions*/,
				oe /*terminalIcon*/,
				ae /*terminalProcessManager*/,
				pe /*terminalRunRecentQuickPick*/,
				$e /*terminalStatusList*/,
				ye /*terminalUri*/,
				ue /*widgetManager*/,
				fe /*lineDataEventAddon*/,
				me /*xtermTerminal*/,
				ve /*history*/,
				ge /*terminal*/,
				be /*terminalColorRegistry*/,
				Ce /*terminalContextKey*/,
				Le /*terminalEnvironment*/,
				Fe /*editorService*/,
				Oe /*environmentService*/,
				xe /*history*/,
				He /*layoutService*/,
				Ke /*pathService*/,
				Je /*preferences*/,
				Te /*amdX*/,
				Ee /*color*/,
				Ie /*terminalColorRegistry*/,
				Be /*hoverWidget*/,
				Se /*reactiveStorageService*/,
				ke /*renderTerminalPromptBar*/,
				Ue /*uuid*/,
				qe /*reactiveStorageTypes2*/,
				Ae /*reactiveStorageTypes*/,
				Me /*aiContext*/,
				De /*constants*/,
				Re /*solid*/,
				je /*cmdKService2*/,
				Ve /*accessibilityCommands*/,
				Ze /*terminalStrings*/,
				et /*terminalClipboard*/,
				rt /*tooltipService*/,
				ft /*tooltipUiWidgets*/,
				bt /*cppEventLogger*/,
				nt /*terminalIconPicker*/,
				lt /*terminalCppService*/,
				ct /*utils*/,
				gt /*host*/,
				ht /*constants*/,
				Rt /*terminalResizeDebouncer*/,
				Nt /*terminal.accessibility*/,
				jt /*terminalContextMenu*/,
				ti /*contextView*/,
				kt /*composer*/,
) {
				"use strict";
