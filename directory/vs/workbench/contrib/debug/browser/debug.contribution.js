...
define(
			...
			function (				ce /*require*/,
				...
				f /*editor*/,
				b /*views*/,
				s /*breakpointEditorContribution*/,
				l /*breakpointsView*/,
				y /*callStackEditorContribution*/,
				$ /*callStackView*/,
				v /*replAccessibleView*/,
				S /*debugColors*/,
				I /*debugCommands*/,
				T /*debugConsoleQuickAccess*/,
				P /*debugEditorActions*/,
				k /*debugEditorContribution*/,
				L /*debugIcons*/,
				D /*debugProgress*/,
				M /*debugQuickAccess*/,
				N /*debugService*/,
				...
				z /*loadedScriptsView*/,
				F /*repl*/,
				x /*statusbarColorProvider*/,
				H /*variablesView*/,
				q /*watchExpressionsView*/,
				V /*welcomeView*/,
				G /*debug*/,
				K /*debugContentProvider*/,
				J /*debugLifecycle*/,
				W /*debugVisualizers*/,
				X /*disassemblyViewInput*/,
				Y /*notebookVariableCommands*/,
				ie /*configuration*/,
				ne /*lifecycle*/,
				ee /*replAccessibilityHelp*/,
				_ /*replAccessibilityAnnouncer*/,
				te /*runAndDebugAccessibilityHelp*/,
				Q /*debugAccessibilityAnnouncer*/,
) {
				"use strict";
