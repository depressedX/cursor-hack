...
define(
			...
			function (				ce /*require*/,
				...
				A /*bulkCellEdits*/,
				R /*interactiveCommon*/,
				O /*interactiveDocumentService*/,
				B /*interactiveEditor*/,
				U /*interactiveEditorInput*/,
				z /*interactiveHistoryService*/,
				F /*coreActions*/,
				x /*notebookIcons*/,
				H /*notebookEditorService*/,
				q /*notebookCommon*/,
				V /*notebookContextKeys*/,
				G /*notebookKernelService*/,
				K /*notebookService*/,
				J /*editorGroupColumn*/,
				W /*editorGroupsService*/,
				X /*editorResolverService*/,
				Y /*editorService*/,
				ie /*extensions*/,
				ne /*workingCopyEditorService*/,
) {
				"use strict";
