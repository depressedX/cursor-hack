...
define(
			...
			function (				ce /*require*/,
				...
				k /*repositoryService*/,
				L /*inlineDiffService*/,
				D /*simpleInlineDiffService*/,
				M /*resolverService*/,
				N /*cursorCredsService*/,
				A /*telemetry*/,
				...
				x /*notification*/,
				H /*reducerService*/,
				q /*agentDebuggerService*/,
				V /*search*/,
				G /*queryBuilder*/,
				K /*anythingQuickAccess*/,
				J /*dataScrubbingService*/,
				W /*symbolsQuickAccess*/,
				X /*editorQuickAccess*/,
				Y /*quickAccess*/,
				ie /*textfiles*/,
				ne /*outlineModel*/,
				...
				te /*markers*/,
				Q /*undoRedo*/,
				Z /*interfaceAgentService*/,
				se /*aiErrorService*/,
				re /*simpleTestService*/,
				le /*aichat*/,
				oe /*aiTaskServiceInterface*/,
				ae /*viewsService*/,
				pe /*fastContextService*/,
				$e /*fastEditService*/,
				ye /*workspaces*/,
				ue /*label*/,
				fe /*remoteAgentService*/,
				me /*contextView*/,
				ve /*cmdKService*/,
				ge /*cmdKService2*/,
				be /*aiProjectService*/,
				Ce /*editorGroupsService*/,
				Le /*aiContext*/,
				Fe /*productService*/,
				Oe /*gitContextService*/,
				xe /*chatDataService*/,
				He /*interpreterService*/,
				Ke /*contextkey*/,
				Je /*environment*/,
				Te /*metricsService*/,
				Ee /*diffingService*/,
				Ie /*window*/,
				Be /*webConstants*/,
				Se /*aiApplyToFileActionsService*/,
				ke /*aiFeatureStatusService*/,
				Ue /*tokenStreamingDiffService*/,
				qe /*aiWebCmdKService*/,
				Ae /*textResourceConfiguration*/,
				Me /*hover*/,
				De /*aiReader*/,
				Re /*aiEverythingProviderService*/,
				je /*fastSemSearchService*/,
				Ve /*tooltipService*/,
				Ze /*commitNotesService*/,
				et /*sourceFilesService*/,
				rt /*layoutService*/,
				ft /*lexicalReducerService*/,
				bt /*dialogs*/,
				nt /*hallucinatedFunctionsDataService*/,
				lt /*gitGraphService*/,
				ct /*scm*/,
				gt /*recentFilesTrackerService*/,
				ht /*extensions*/,
				Rt /*panecomposite*/,
				Nt /*aicontextService*/,
				jt /*contextBankService*/,
				ti /*composer*/,
				kt /*composerDataService*/,
				hi /*statusbar*/,
				Kt /*languageFeatures*/,
				di /*selectedContext*/,
				Ye /*notepad*/,
				ze /*utils*/,
				Xe /*terminalExecutionService*/,
				It /*semSearchService*/,
				Lt /*composerViews*/,
				xt /*decorations*/,
				Vt /*lifecycle*/,
				Bt /*composerUtilsService*/,
				Gt /*customEditorLabelService*/,
				Mt /*bugbot*/,
				Ut /*bugbotDataService*/,
				ei /*aiServerConfigService*/,
				mi /*editorWorker*/,
				ii /*prettyDialog*/,
				Dt /*bugBotLinterService*/,
) {
				"use strict";
