...
define(
			...
			function (				ce /*require*/,
				...
				g /*chatData*/,
				p /*useBubblePills*/,
				o /*useTabBubbleMentionSideEffects*/,
				f /*utils*/,
				b /*aiConfigHelper*/,
				s /*constants*/,
				l /*solid*/,
				...
				$ /*useKeyboardShortcut*/,
				v /*ContextPills*/,
				S /*selectedContextData*/,
				I /*codicons*/,
				T /*themables*/,
				P /*modelToggle*/,
				k /*uuid*/,
				L /*fullInputBoxAdvancedCodebaseMenu*/,
				D /*hooks*/,
				M /*platform*/,
				N /*usePremiumPickerMenuProps*/,
				A /*keybindingResolver*/,
				R /*keyboardEvent*/,
				O /*useAltAddSuggestedPills*/,
) {
				"use strict";
