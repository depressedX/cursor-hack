...
import '../../../../css!vs/workbench/contrib/preferences/browser/media/settingsEditor2.js';
define(
			de[4355],
			he([
			...
			function (				ce /*require*/,
				...
				k /*userDataSync*/,
				L /*editorPane*/,
				D /*suggestEnabledInput*/,
				M /*preferencesWidgets*/,
				N /*settingsLayout*/,
				A /*settingsTree*/,
				R /*settingsTreeModels*/,
				O /*tocTree*/,
				B /*preferences*/,
				U /*settingsEditorColorRegistry*/,
				...
				V /*workspaceTrust*/,
				G /*configuration*/,
				K /*textResourceConfiguration*/,
				J /*extensions*/,
				W /*splitview*/,
				X /*color*/,
				Y /*language*/,
				ie /*settingsSearchMenu*/,
				ne /*extensionManagement*/,
				ee /*configurationRegistry*/,
				_ /*platform*/,
				te /*defaultStyles*/,
				Q /*productService*/,
				Z /*widgetNavigationCommands*/,
				se /*progress*/,
				re /*userDataProfile*/,
) {
				"use strict";
