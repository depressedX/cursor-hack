...
import './diff/notebookDiffEditor.js';
...
import './services/notebookCellStatusBarServiceImpl.js';
...
import './diff/diffElementViewModel.js';
...
import '../common/notebookKeymapService.js';
...
import '../../comments/browser/commentReply.js';
...
import './contrib/notebookVariables/notebookVariables.js';
import '../../../../platform/accessibility/browser/accessibleViewRegistry.js';
import './notebookAccessibilityHelp.js';
import './notebookAccessibleView.js';
import '../../format/browser/formatActionsMultiple.js';
import './diff/notebookMultiDiffEditor.js';
...
define(
		...
		function (			ce /*require*/,
			...
			y /*editor*/,
			$ /*notebookEditor*/,
			v /*notebookEditorInput*/,
			S /*notebookService*/,
			I /*notebookServiceImpl*/,
			T /*notebookCommon*/,
			P /*editorService*/,
			k /*undoRedo*/,
			L /*notebookEditorModelResolverService*/,
			D /*notebookDiffEditorInput*/,
			M /*notebookDiffEditor*/,
			N /*notebookWorkerService*/,
			A /*notebookWorkerServiceImpl*/,
			R /*notebookCellStatusBarService*/,
			O /*notebookCellStatusBarServiceImpl*/,
			B /*notebookEditorService*/,
			U /*notebookEditorServiceImpl*/,
			z /*jsonContributionRegistry*/,
			F /*event*/,
			x /*diffElementViewModel*/,
			H /*notebookEditorModelResolverServiceImpl*/,
			q /*notebookKernelService*/,
			V /*notebookKernelServiceImpl*/,
			G /*extensions*/,
			K /*workingCopyEditorService*/,
			J /*configuration*/,
			W /*label*/,
			X /*editorGroupsService*/,
			Y /*notebookRendererMessagingServiceImpl*/,
			ie /*notebookRendererMessagingService*/,
			ne /*notebookOutlineDataSourceFactory*/,
			ee /*editorOptions*/,
			_ /*notebookExecutionStateServiceImpl*/,
			te /*notebookExecutionServiceImpl*/,
			Q /*notebookExecutionService*/,
			Z /*notebookKeymapService*/,
			se /*notebookKeymapServiceImpl*/,
			re /*modesRegistry*/,
			le /*notebookExecutionStateService*/,
			oe /*languageFeatures*/,
			ae /*commentReply*/,
			pe /*codeEditorService*/,
			$e /*notebookKernelHistoryServiceImpl*/,
			ye /*notebookLoggingService*/,
			ue /*notebookLoggingServiceImpl*/,
			fe /*product*/,
			me /*notebookVariables*/,
			ve /*accessibleViewRegistry*/,
			ge /*notebookAccessibilityHelp*/,
			be /*notebookAccessibleView*/,
			Ce /*formatActionsMultiple*/,
			Le /*notebookMultiDiffEditor*/,
			Fe /*notebookMultiDiffEditorInput*/,
) {
			"use strict";
			var Oe;
