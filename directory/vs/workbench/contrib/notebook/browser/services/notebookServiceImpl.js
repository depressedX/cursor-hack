...
define(
			...
			function (				ce /*require*/,
				...
				f /*storage*/,
				b /*memento*/,
				s /*notebookExtensionPoint*/,
				l /*notebookDiffEditorInput*/,
				y /*notebookTextModel*/,
				$ /*notebookCommon*/,
				v /*notebookEditorInput*/,
				S /*notebookEditorModelResolverService*/,
				I /*notebookOutputRenderer*/,
				T /*notebookProvider*/,
				P /*notebookService*/,
				k /*editorResolverService*/,
				L /*extensions*/,
				D /*extensionsActions*/,
				M /*uriIdentity*/,
				N /*notebookDocumentService*/,
				A /*mergeEditorInput*/,
				R /*buffer*/,
				O /*notebookMultiDiffEditorInput*/,
) {
				"use strict";
				var B, U;
