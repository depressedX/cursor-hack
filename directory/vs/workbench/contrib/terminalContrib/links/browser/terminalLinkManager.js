...
define(
			...
			function (				ce /*require*/,
				...
				u /*tunnel*/,
				a /*links*/,
				h /*terminalExternalLinkDetector*/,
				c /*terminalLinkDetectorAdapter*/,
				n /*terminalLinkOpeners*/,
				g /*terminalLocalLinkDetector*/,
				p /*terminalUriLinkDetector*/,
				o /*terminalWordLinkDetector*/,
				f /*terminal*/,
				b /*terminalHoverWidget*/,
				s /*terminal*/,
				l /*terminalLinkHelpers*/,
				y /*async*/,
				$ /*terminal*/,
				v /*terminalMultiLineLinkDetector*/,
				S /*notification*/,
) {
				"use strict";
