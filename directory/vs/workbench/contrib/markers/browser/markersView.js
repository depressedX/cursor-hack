...
import '../../../../css!vs/workbench/contrib/markers/browser/media/markers.js';
define(
		de[4025],
		he([
		...
		function (			ce /*require*/,
			...
			x /*markersTable*/,
			H /*markers*/,
			q /*widgetNavigationCommands*/,
			V /*hover*/,
			G /*keybindingResolver*/,
) {
			"use strict";
