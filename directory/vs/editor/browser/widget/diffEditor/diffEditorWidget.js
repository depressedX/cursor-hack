...
define(
			...
			function (				ce /*require*/,
				...
				r /*editorExtensions*/,
				u /*codeEditorService*/,
				a /*stableEditorScroll*/,
				h /*codeEditorWidget*/,
				c /*accessibleDiffViewer*/,
				n /*diffEditorDecorations*/,
				g /*diffEditorSash*/,
				p /*diffEditorViewZones*/,
				o /*gutterFeature*/,
				f /*hideUnchangedRegionsFeature*/,
				b /*movedBlocksLinesFeature*/,
				s /*overviewRulerFeature*/,
				l /*revertButtonsFeature*/,
				y /*utils*/,
				$ /*hotReloadHelpers*/,
				v /*platformObservableUtils*/,
				S /*position*/,
				I /*range*/,
				T /*cursorEvents*/,
				P /*editorCommon*/,
				...
				A /*progress*/,
				R /*diffEditorEditors*/,
				O /*delegatingEditorImpl*/,
				B /*diffEditorOptions*/,
				U /*diffEditorViewModel*/,
) {
				"use strict";
