...
import './server-runtime-client.js';
import './sdk.js';
import './transports/base.js';
import './transports/offline.js';
import './transports/multiplexed.js';
import './integration.js';
import './utils/applyScopeDataToEvent.js';
import './utils/prepareEvent.js';
import './checkin.js';
import './utils/hasTracingEnabled.js';
import './utils/isSentryRequestUrl.js';
import './utils/handleCallbackErrors.js';
import './utils/parameterize.js';
import './utils/spanUtils.js';
import './utils/parseSampleRate.js';
import './utils/sdkMetadata.js';
import './utils/traceData.js';
import './utils/meta.js';
import './constants.js';
import './breadcrumbs.js';
import './integrations/functiontostring.js';
import './integrations/inboundfilters.js';
import './integrations/linkederrors.js';
import './integrations/metadata.js';
import './integrations/requestdata.js';
import './integrations/captureconsole.js';
import './integrations/debug.js';
import './integrations/dedupe.js';
import './integrations/extraerrordata.js';
import './integrations/rewriteframes.js';
import './integrations/sessiontiming.js';
import './integrations/zoderrors.js';
import './integrations/third-party-errors-filter.js';
import './metrics/exports.js';
import './profiling.js';
import './metrics/exports-default.js';
import './metrics/browser-aggregator.js';
import './metrics/metric-summary.js';
import './fetch.js';
import './trpc.js';
import './feedback.js';
import './getCurrentHubShim.js';
...
define(
		...
		function (			ce /*require*/,
			...
			n /*api*/,
			g /*baseclient*/,
			p /*server-runtime-client*/,
			o /*sdk*/,
			f /*base*/,
			b /*offline*/,
			s /*multiplexed*/,
			l /*integration*/,
			y /*applyScopeDataToEvent*/,
			$ /*prepareEvent*/,
			v /*checkin*/,
			S /*hasTracingEnabled*/,
			I /*isSentryRequestUrl*/,
			T /*handleCallbackErrors*/,
			P /*parameterize*/,
			k /*spanUtils*/,
			L /*parseSampleRate*/,
			D /*sdkMetadata*/,
			...
			K /*sessiontiming*/,
			J /*zoderrors*/,
			W /*third-party-errors-filter*/,
			X /*exports*/,
			Y /*profiling*/,
			ie /*exports-default*/,
			ne /*browser-aggregator*/,
			ee /*metric-summary*/,
			_ /*fetch*/,
			te /*trpc*/,
			Q /*feedback*/,
